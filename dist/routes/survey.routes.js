...
router.get("/admin/responses/:responseId", userAuthMiddleware_1.authMiddleware, requireAdminRole_1.requireAdminRole, survey_controller_1.getAdminSurveyResponseById);
