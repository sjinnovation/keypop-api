...
exports.calculateDetailedStatistics = exports.groupAnswersByCategory = exports.getNextSection = exports.getSectionsSummary = void 0;
// Helper function to get sections summary
const getSectionsSummary = (answers, categories) => {
    const summary = {};
...
exports.getSectionsSummary = getSectionsSummary;
// Helper function to determine next available section
const getNextSection = (currentSection, categories) => {
    var _a, _b;
    if (!currentSection)
        return ((_a = categories[0]) === null || _a === void 0 ? void 0 : _a.code) || null;
    const currentIndex = categories.findIndex(c => c.code === currentSection);
    if (currentIndex === -1 || currentIndex === categories.length - 1) {
        return null; // No next section
    }
    return ((_b = categories[currentIndex + 1]) === null || _b === void 0 ? void 0 : _b.code) || null;
};
exports.getNextSection = getNextSection;
// Helper function to group answers by category
const groupAnswersByCategory = (answers, categories) => {
    const grouped = {};
    categories.forEach(category => {
...
exports.groupAnswersByCategory = groupAnswersByCategory;
// Helper function to calculate detailed statistics
const calculateDetailedStatistics = (answers, questions) => {
    const answerTypes = {
        ...
        if (type === 'rating') {
            ...
            if (!answer.skipped && answer.value !== null) {
                ...
                if (answer.value === true)
                    answerTypes.yesNo.yesCount++;
                else
                    answerTypes.yesNo.noCount++;
            }
            else {
...
exports.calculateDetailedStatistics = calculateDetailedStatistics;
